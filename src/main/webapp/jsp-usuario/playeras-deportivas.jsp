...
<div class = "row">
    <aside>
        ...
        <ul class="lista">
            <li><a href="<%= request.getContextPath()%>/jsp-usuario/productos.jsp">Playeras</a> </li>
            <li><a class = "active" href="<%= request.getContextPath()%>/jsp-usuario/playeras-deportivas.jsp">Playeras deportivas</a> </li>
