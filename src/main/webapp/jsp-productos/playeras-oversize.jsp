...
<head>
    ...
    <title>Playeras oversize personalizadas</title>
...
<div class = "row">
    <aside>
        ...
        <ul class="lista">
            ...
            <li><a class = "active" href="<%= request.getContextPath()%>/jsp-productos/playeras-oversize.jsp">Playeras oversize personalizadas</a></li>
        </ul>
